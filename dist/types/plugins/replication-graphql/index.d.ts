...
export declare class RxGraphQLReplicationState {
    ...
    constructor(collection: RxCollection, url: string, headers: {
        [k: string]: string;
    }, pull: GraphQLSyncPullOptions, push: GraphQLSyncPushOptions, deletedFlag: string, lastPulledRevField: string, live: boolean, liveInterval: number, retryTime: number, syncRevisions: boolean, credentials?: RequestCredentials | undefined);
    client: any;
    endpointHash: string;
    _subjects: {
...
export declare function syncGraphQL(this: RxCollection, { url, headers, credentials, waitForLeadership, pull, push, deletedFlag, lastPulledRevField, live, liveInterval, // in ms
retryTime, // in ms
